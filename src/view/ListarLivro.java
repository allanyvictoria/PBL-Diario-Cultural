...
/**
 * Classe responsável por exibir o menu de listagem de livros, onde o usuário pode
 * escolher entre listar os livros mais ou menos avaliados, com a opção de aplicar filtros adicionais.
 */
public class ListarLivro {

    /**
     * Metodo que exibe o menu de listagem de livros e permite que o usuário escolha entre
     * visualizar os livros mais ou menos avaliadas.
    ...
    public static void listar() {
        ...
        while (loop) {
            ...
            switch (opcao) {
                case 1 ->{
                    Acervo.listarLivrosAvaliacao(true);
                    filtro();
                }
                case 2 ->{
                    Acervo.listarLivrosAvaliacao(false);
                    filtro();
                }
                case 3 -> {
    ...
    /**
     * Metodo que exibe o menu de filtros adicionais, permitindo que o usuário filtre os livros
    ...
    public static void filtro() {
        ...
        while (loop) {
            ...
            switch (opcao) {
                ...
                case 2 -> {
                    int ano = VerificaInteiro.verificaInteiro("Digite o " +
                            "ano de lançamento que deseja buscar: ");
                    BuscaLivro.ano(ano);
                    loop = false;
                }
                case 3 -> {
